...
BATCH_SENDER_ERROR = 'CGBSSERR005: Error occured while calling the batche receiver'
UNEXPECTED_ERROR = 'CGBSSERR006: Unexpected exception occured'
MISSING_CONFIG = 'CGBSSERR007: Missing config: %s'
...
NATS_REQUEST_TIMED_OUT = 'CGBSSLOG008: Requesting next message from jetstream'
